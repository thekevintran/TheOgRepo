...
public class GridViewItemAdapter extends ArrayAdapter<ListItem> {
    private LayoutInflater mInflater;
    public GridViewItemAdapter(Context context, int rid, List<ListItem> list){
        super(context, rid, list);
        mInflater =
                (LayoutInflater)context.getSystemService(context.LAYOUT_INFLATER_SERVICE);
    }
    public View getView(int position, View convertView, ViewGroup parent){
        Log.v("Lab4", "Public View in GridViewItem Adapter");
        // Retrieve data
        ListItem item = (ListItem)getItem(position);
        // Use layout file to generate View
        View view = mInflater.inflate(R.layout.gridview, null);
        // Set image
        ImageView image;
